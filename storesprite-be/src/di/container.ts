...
import { SettingRepository } from "../repositories/user/SettingRepository.js";
...
import { MappingHistoryRepository } from "../repositories/stocksprite/MappingHistoryRepository.js";
...
import { UnasClientFactory } from "../services/unas/UnasClientFactory.js";
...
export function createContainer(orm?: MikroORM): Container {
  ...
  container.bind(TYPES.IMappingHistoryRepository).to(MappingHistoryRepository).inRequestScope();
