...
import { DtoDifference } from "./index.js";
...
export function comparePlainProductDto(leftProductDto: ProductDto, rightProductDto: ProductDto): DtoDifference[] {
    ...
    return diff(normalizedLeft as object, normalizedRight as object) as DtoDifference[];
}

export function mergePlainProductDto(targetProductDto: ProductDto, sourceProductDto: ProductDto): ProductDto {
...
export function arrayMergeByKey<T extends object>(keys: (keyof T)[]) {
